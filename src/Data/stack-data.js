export const frontendData = [
  ...
  {
    imgSrc: '/icons/jest-icon.png',
    imgAlt: 'The Jest Logo',
    linkUrl: 'https://jestjs.io/',
    title: 'Jest',
  },
  {
    imgSrc: '/icons/rtl-icon.png',
  ...
  {
    imgSrc: '/icons/yarn-icon.png',
    imgAlt: 'The Yarn Logo',
    linkUrl: 'https://yarnpkg.com/',
...
export const backendData = [
  {
    imgSrc: '/icons/scala-icon.png',
    imgAlt: 'The Scala Logo',
    linkUrl: 'https://www.scala-lang.org/',
    title: 'Scala',
  },
  {
    imgSrc: '/icons/scalatra-icon.png',
    imgAlt: 'The Scalatra Logo',
    linkUrl: 'https://scalatra.org/',
    title: 'Scalatra',
  },
  {
    imgSrc: '/icons/scalatest-icon.png',
    imgAlt: 'The Scalatest Logo',
    linkUrl: 'https://www.scalatest.org/',
    title: 'Scalatest',
  },
  {
    imgSrc: '/icons/cucumber-icon.png',
    imgAlt: 'The Cucumber Logo',
    linkUrl: 'https://cucumber.io/',
    title: 'Cucumber',
  },
  {
    imgSrc: '/icons/sbt-icon.png',
    imgAlt: 'The Simple Build Tool Logo',
    linkUrl: 'https://www.scala-sbt.org/',
...
export const otherToolsData = [
  ...
  {
    imgSrc: '/icons/aws-icon.png',
    imgAlt: 'The Amazon Web Services Logo',
    linkUrl: 'https://aws.amazon.com/',
    title: 'Amazon Web Services',
  },
  {
    imgSrc: '/icons/jenkins-icon.png',
    imgAlt: 'The Jenkins Logo',
    linkUrl: 'https://www.jenkins.io/',
    title: 'Jenkins',
  },
  {
    imgSrc: '/icons/jira-icon.png',
    imgAlt: 'The Jira Logo',
    linkUrl: 'https://www.atlassian.com/software/jira',
    title: 'Jira',
  },
];

export const seoListData = [
  {
